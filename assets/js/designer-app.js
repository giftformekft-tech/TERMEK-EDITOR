(function(){
  ...
  document.getElementById('nb-save').onclick = async ()=>{
    ...
    const typeLabel = selectedOptionText(typeSel) || type;
    const colorLabel = selectedOptionText(colorSel) || color;
    const sizeLabel = selectedOptionText(sizeSel) || size;
    const price_ctx = {product_id:pid, type, color, size, type_label:typeLabel, color_label:colorLabel, size_label:sizeLabel};
