<div id="nb-designer">
  ...
  <div class="nb-modal" id="nb-templates-modal" hidden>
    ...
    <div class="nb-modal-dialog" role="dialog" aria-modal="true" aria-labelledby="nb-templates-modal-title">
      ...
      <div class="nb-modal-body">
        <div class="nb-modal-grid" id="nb-templates-list" style="display:grid; grid-template-columns:repeat(auto-fill,minmax(120px,1fr)); gap:1rem;"></div>
      </div>
    </div>
  </div>
</div>
