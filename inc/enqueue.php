...
add_action('wp_enqueue_scripts', function(){
  if ( is_page() && has_shortcode(get_post()->post_content ?? '', 'nb_designer') ) {
    wp_enqueue_style('nb-designer', NB_DESIGNER_URL.'assets/css/designer.css', [], '1.4.0');
    wp_enqueue_script('fabric', 'https://cdn.jsdelivr.net/npm/fabric@5.3.0/dist/fabric.min.js', [], null, true);
    wp_enqueue_script('nb-designer', NB_DESIGNER_URL.'assets/js/designer-app.js', ['fabric','jquery'], '1.4.0', true);
...
add_action('admin_enqueue_scripts', function($hook){
  if ( isset($_GET['page']) && $_GET['page']==='nb-designer' ) {
    wp_enqueue_media();
    wp_enqueue_style('nb-admin', NB_DESIGNER_URL.'admin/css/admin.css', [], '1.4.0');
    wp_enqueue_script('fabric', 'https://cdn.jsdelivr.net/npm/fabric@5.3.0/dist/fabric.min.js', [], null, true);
    wp_enqueue_script('nb-admin', NB_DESIGNER_URL.'admin/js/admin.js', ['jquery','fabric'], '1.4.0', true);
